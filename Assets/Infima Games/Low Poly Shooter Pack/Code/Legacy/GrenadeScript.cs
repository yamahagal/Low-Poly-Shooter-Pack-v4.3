...
namespace InfimaGames.LowPolyShooterPack.Legacy {
    public class GrenadeScript : MonoBehaviour {
        ...
        private bool hasEnemyHit = false;
        ...
        private IEnumerator ExplosionTimer() {
            ...
            foreach (Collider hit in colliders) {
                ...
                if (hit.GetComponent<Collider>().tag == "Enemy" || hit.GetComponent<Collider>().tag == "EnemyBody") { //  && !hasEnemyHit || hit.GetComponent<Collider>().tag == "EnemyHead" || hit.GetComponent<Collider>().tag == "EnemyLimbs"
