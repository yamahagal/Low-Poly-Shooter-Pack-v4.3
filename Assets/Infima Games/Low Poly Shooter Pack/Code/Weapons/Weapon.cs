...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Weapon : WeaponBehaviour
    {
        ...
        [Tooltip("Weapon Type. Currently not used for anything, but in the future, we will use this for give weapons names!")]
        [SerializeField]
        ...
        [Tooltip("This is the distance at which your enemies can hear you if you do not have a silencer.")]
        [SerializeField]
        private float notSilencerRadius;
        ...
        public override void Fire(float spreadMultiplier = 1.0f)
        {
            ...
            float radius = 0;
            string missile = attachmentManager.GetEquippedMuzzle().gameObject.name;
            if (missile == "P_LPSP_WEP_ATT_Muzzle") {
                radius = notSilencerRadius;
            } else {
            ...
            foreach (Collider hit in colliders) {
                if (hit.gameObject.name == "Body_collider") {
                    hit.GetComponent<BodyCollider>().enemyNavigation.RotateToTarget();
                }
            }
